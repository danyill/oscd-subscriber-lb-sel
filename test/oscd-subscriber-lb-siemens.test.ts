...
import type SubscriberLaterBindingSEL from '../oscd-subscriber-lb-sel.js';
...
const plugins = {
  menu: [
    {
      name: 'Subscriber Later Binding - SEL',
      translations: {
...
const plugin: SubscriberLaterBindingSEL = document
  .querySelector('open-scd')!
  .shadowRoot!.querySelector<SubscriberLaterBindingSEL>('aside > :last-child')!;
